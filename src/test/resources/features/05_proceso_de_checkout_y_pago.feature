...
Cuando inicio sesión con email "user@prueba.com" y contraseña "userQA"
...
Y  se ingresa "Por favor entregar en horario de oficina" en el campo "Order Comment"
...
Entonces se muestra el mensaje "Your order has been placed successfully!"
...
| AnioExpiracion  | 2028             |
Y hace clic en el botón "Pay and Confirm Order"
Entonces la validación debe solicitar completar el campo obligatorio "Name on Card"
...
| AnioExpiracion  | 2028    |
Y hace clic en el botón "Pay and Confirm Order"
Entonces la validación debe solicitar completar el campo obligatorio "Card Number"
...
| AnioExpiracion  | 2028             |
Y hace clic en el botón "Pay and Confirm Order"
Entonces la validación debe solicitar completar el campo obligatorio "CVC"
...
| AnioExpiracion  | 2028             |
Y hace clic en el botón "Pay and Confirm Order"
Entonces la validación debe solicitar completar el campo obligatorio "Expiration Month"
